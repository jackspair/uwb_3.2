...
void ModeDrawPicture::generate_path()
{
    ...
    wp_nav->get_wp_stopping_point(path[0]);
    path[1]=path[0]+Vector3f(1.0f,0,0)*radius_cm;
    path[2]=path[0]+Vector3f(1.0f,2.0f,0)*radius_cm;
    path[3]=path[0]+Vector3f(0,2.0f,0)*radius_cm;
    path[4]=path[0];
    path[5]=path[0]+Vector3f(0,1.0f,0)*radius_cm;
    path[6]=path[0]+Vector3f(2.0f,1.0f,0)*radius_cm;
    path[7]=path[0]+Vector3f(-2.0f,1.0f,0)*radius_cm;
}
