...
bool ModePosHoldUWB::init(bool ignore_checks)
{
...
void ModePosHoldUWB::update_pilot_lean_angle(float &lean_angle_filtered, float &lean_angle_raw)
{
...
float ModePosHoldUWB::mix_controls(float mix_ratio, float first_control, float second_control)
{
...
void ModePosHoldUWB::update_brake_angle_from_velocity(float &brake_angle, float velocity)
{
    float lean_angle;
...
void ModePosHoldUWB::init_wind_comp_estimate()
{
    wind_comp_ef.zero();
    wind_comp_timer = 0;
    wind_comp_roll = 0.0f;
...
void ModePosHoldUWB::update_wind_comp_estimate()
{
...
void ModePosHoldUWB::get_wind_comp_lean_angles(float &roll_angle, float &pitch_angle)
{
    // reduce rate to 10hz
    wind_comp_timer++;
...
void ModePosHoldUWB::roll_controller_to_pilot_override()
{
...
void ModePosHoldUWB::pitch_controller_to_pilot_override()
{
