...
class ModePosHoldUWB : public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::ModePosHoldUWB; }
...
protected:
    ...
    const char *name() const override { return "PosHoldUWB"; }
    const char *name4() const override { return "PosHoldUWB"; }
