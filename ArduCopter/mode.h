...
class ModeDrawPicture : public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::DRAWPICTURE; }
...
protected:
    ...
    const char *name() const override { return "DRAWPICTURE"; }
    const char *name4() const override { return "DRAWPICTURE"; }
